        ...
        {{-- No es necesario el action, basta con agregar method=post para que lo gestione web.php --}}
            <form method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="owner_name" id="owner_name" class="form-control uppercase" required value="{{ old('owner_name') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pet_name" id="pet_name" class="form-control uppercase" required value="{{ old('pet_name') }}">
